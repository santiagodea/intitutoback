...
public class CourseController {
	...
	public ResponseEntity<CourseDTO> update(@RequestBody CourseDTO courseDTO) throws NoSuchMessageException {
		courseDTO = this.courseService.update(courseDTO);
		return new ResponseEntity<CourseDTO>(courseDTO, HttpStatus.OK);
	}

	@RequestMapping(value = "/delete/{id}", method = RequestMethod.DELETE)
	public ResponseEntity<Void> delete(@PathVariable("id") long id) throws NoSuchMessageException {
